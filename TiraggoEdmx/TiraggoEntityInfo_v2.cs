...
{
    public partial class TiraggoEntityInfo_v2
    {
        private Edmx edmx;

        public TiraggoEntityInfo_v2(Edmx edm, string fullName)
        {
            edmx = edm;
            ...
            ConceptualModel = edmx.Runtime.ConceptualModels.Schema.EntityType
